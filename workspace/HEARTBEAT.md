...
1. **Mentions scan** [agent-browser] → Log: `data/daily/YYYY-MM-DD/mentions.md`
   Check for new @trust8004 mentions. Reply within 30 min
2. **Keyword monitor** [agent-browser] → Log: `data/daily/YYYY-MM-DD/engagement_search.md`
   Quick scan for "ERC8004", "ERC-8004" mentions
3. **Reply to Fix My Agent submissions** [agent-browser] → Log: `data/audits/YYYY-MM-DD_CHAINID-ID.md`
...
- [ ] (Monday) Generate weekly analytics report [agent-browser] → Log: `data/weekly/YYYY-WNN/analytics_report.md` → Send to Gilberts via Telegram
...
- [ ] Run keyword/hashtag search (ERC8004, AI agents, chain names) [agent-browser] → Log: `data/daily/YYYY-MM-DD/engagement_search.md`
- [ ] Engage: like, reply, follow relevant accounts [agent-browser] → Log: `data/daily/YYYY-MM-DD/engagement_actions.md`
- [ ] Check for trending topics related to on-chain AI [agent-browser]
...
- [ ] 7:00 PM: Micro-influencer outreach (identify 2-3, engage thoughtfully) [agent-browser] → Log: `data/daily/YYYY-MM-DD/engagement_actions.md`
- [ ] Review day's engagement metrics [agent-browser]
- [ ] Report daily follower delta to Gilberts via Telegram

## End of Day

- [ ] Respond to any pending replies/mentions [agent-browser] → Log: `data/daily/YYYY-MM-DD/engagement_actions.md`
